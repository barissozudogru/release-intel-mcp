...
```bash
claude mcp add release-intel-dev -e GITHUB_TOKEN=ghp_your_token -- node /absolute/path/to/dist/index.js
```
...
```
feat: add label-based filtering to get_pull_requests_in_range
fix: handle repos with no tags gracefully
